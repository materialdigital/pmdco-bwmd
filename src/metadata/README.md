 ...
 * [bwmd.yml](bwmd.yml)
     * Determines how your purl.obolibrary.org/obo/bwmd/ redirects will be handled
     ...
     * Paste in the contents of [bwmd.yml](bwmd.yml)
 ...
 * [bwmd.md](bwmd.md)
     ...
     * Paste in the contents of [bwmd.md](bwmd.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
